...
<body>
    ...
    <div class="admin-container">
        ...
        <div class="admin-welcome">
            <div><h1><i class="fas fa-edit" style="color:#667eea;"></i> Edit Product</h1><p>Update product #<?php echo $product['product_id']; ?>: <?php echo htmlspecialchars($product['product_name']); ?></p></div>
        </div>
                        ...
                        <div class="form-group">
                            ...
                            <?php if ($product['product_image']): ?>
                                <div class="current-image">
                                    <img src="<?php echo url('/' . htmlspecialchars($product['product_image'])); ?>" alt="Current image">
                            ...
                            <div class="image-upload-area" id="imageUploadArea">
                                ...
                                <p><?php echo $product['product_image'] ? 'Upload new image (replaces current)' : 'Click or drag to upload'; ?></p>
