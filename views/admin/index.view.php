...
<body>
    <header class="header">
        <div class="container">
            ...
            <nav>
                ...
                <span style="color:#718096; margin-left:16px;">Hello, <?php echo htmlspecialchars($_SESSION['full_name']); ?></span>
                <a href="<?php echo url('/admin/logout.php'); ?>" style="color:#e53e3e;"><i class="fas fa-sign-out-alt"></i> Logout</a>
            </nav>
        </div>
    </header>
    ...
    <main style="max-width:1200px; margin:40px auto; padding:0 20px;">
        ...
        <p style="color:#718096; margin-top:8px;">Logged in as: <?php echo htmlspecialchars($_SESSION['email']); ?></p>
    </main>
